//basic phonebook using a Dictionary key-value pair system
...
class PhoneBook
{
  ...
  static void Main()
  {
    ...
    Console.WriteLine("Would you like to add a new contact to your phone book? ['Y' for yes, 'Enter' for no]");
  ...
  static void AddContact()
  {
    ...
    Console.WriteLine("Enter a name for the new contact");
  ...
  static void LookUpContact()
  {
    ...
    if (phoneNumbers.ContainsKey(friend))
    {
      ...
      Console.Write(friend + "\'s number is " + value);
    } 
    else 
    {
      Console.WriteLine("That person is not in your phone book.");
      Console.WriteLine("Would you like to add this person now? ['Y' for yes, 'Enter' for no]");
